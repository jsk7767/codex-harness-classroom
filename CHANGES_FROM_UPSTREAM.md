...
- Added an Obsidian-first evidence contract and a deterministic unsupported-claim validator that checks citation syntax, safe vault-relative paths, non-empty evidence files, and minimal text support before the independent Quality Checker performs semantic review.
